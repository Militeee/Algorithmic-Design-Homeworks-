...
// fiils the m and s matrix with the optimal subsequence (dynamic programming
// step)

void
matrixChainAux(int* P, int** m, int** s, size_t i, size_t j)
{
  m[i][j] = INFINITY;
...
*/
void
matrixChain(int*** res, int* P, size_t n)
{
...
void
print_parenthesis(int** S, int i, int j)
{
  if (i == j)
    printf("A%d", i);
  else {
