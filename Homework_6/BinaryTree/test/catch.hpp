...
struct ITestCaseRegistry
{
  ...
  virtual void getFilteredTests(TestSpec const& testSpec,
...
TestCase
makeTestCase(ITestCase* testCase,
                        ...
                        std::vector<TestCase>& matchingTestCases)
  {
    switch (config.runOrder()) {
      case RunTests::InLexicographicalOrder:
        std::sort(
          matchingTestCases.begin(), matchingTestCases.end(), LexSort());
        break;
      case RunTests::InRandomOrder: {
        RandomNumberGenerator rng;
        std::random_shuffle(
          matchingTestCases.begin(), matchingTestCases.end(), rng);
      } break;
...
void
AutoReg::registerTestCase(ITestCase* testCase,
...
struct NoColourImpl : IColourImpl
{
  ...
  !defined(CATCH_CONFIG_COLOUR_WINDOWS) && !defined(CATCH_CONFIG_COLOUR_ANSI)
#ifdef CATCH_PLATFORM_WINDOWS
...
TestCase
makeTestCase(ITestCase* _testCase,
             std::string const& _className,
             std::string const& _name,
...
void
TagAliasRegistry::add(char const* alias,
                      char const* tag,
                      SourceLineInfo const& lineInfo)
{
